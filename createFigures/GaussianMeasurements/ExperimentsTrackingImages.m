function [] = ExperimentsTrackingImages(Algorithm_parameters, Execution_parameters)
...
if USE_MYGAUSSIAN_OP
    ...
    f_2_diff = spgl1(Am, y_2 - y_b, 0 , 0, vec(Im_backgr), opts_spgl1);
end
...
if USE_MYGAUSSIAN_OP
    ...
    f_3_diff = spgl1(Am, y_3 - y_b, 0 , 0, vec(Im_backgr), opts_spgl1);
end
...
for kk = 3 : nFrames
    ...
    if USE_MYGAUSSIAN_OP
        ...
        A_k_pinv = pinv(Am);
        f_k_diff = solverL1L1_name(y_k - y_b, w, 1, 1, Am, A_k_pinv, ...
            MAX_ITER_L1L1);        
    end
