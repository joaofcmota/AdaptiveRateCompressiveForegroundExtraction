function [xsol, output] = decoptL1L1(b, w, beta, mode, arg1, arg2, ...
    varargin)

% [xsol, output] = decoptL1L1(b, w, beta, mode, arg1, arg2, varargin)
%
% Solves 
%
...
preprocess_time = tic;
if mode == 1
    [pdata, opts] = decoptPreSolver('L1-L1', A, b, 'X0', w);
else
    [pdata, opts] = decoptPreSolver('L1-L1', A, b, 'NX', n, 'X0', w, ...
        'AT', AT);
end
