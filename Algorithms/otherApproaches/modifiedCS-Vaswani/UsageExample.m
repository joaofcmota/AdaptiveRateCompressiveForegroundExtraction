% Usage example of modifiedCS.m
%
% =========================================================================
% basisPursuitPlusL1: minimizing L1 + L1 with linear constraints
% Copyright (C) 2014  Joao Mota, Nikos Deligiannis, Miguel Rodrigues
% 
...
% Estimate support
T = (abs(w) >= 0.5);  % By looking at the histogram of w

A = randn(m,n);
b = A*x;

[x_opt_mode1, k1] = ModifiedCS(b, T, 1, A, pinv(A));
% =========================================================================
...
[x_opt_mode2, k2] = ModifiedCS(b, T, 2, A_handler, AT_handler);
% =========================================================================
